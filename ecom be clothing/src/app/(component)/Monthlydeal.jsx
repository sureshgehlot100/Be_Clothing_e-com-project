            ...
            <div className='w-[78%] mt-20'>
                ...
                <div className="flex justify-evenly md:my-3 lg:my-6 flex-wrap">
                    <div className="relative group" >
                        ...
                        <h3 className="text-lg text-gray-600 my-2">Aliquam erat ac ipsum</h3>
                        <p className="text-sm text-gray-600 mb-4">£24.00</p>
                    </div>
                    <div className="relative group">
                        <Image
                            src="https://themes.muffingroup.com/be/clothing2/wp-content/uploads/2020/07/clothing2-products-pic11-300x300.jpg"
                            alt="Weekly Deal Image"
                            width={227}
                            height={100}
                            style={{ objectFit: 'cover' }}
                        ...
                        <h3 className="text-lg text-gray-600 my-2">Aliquam sem</h3>
                        <p className="text-sm text-gray-600 mb-4">£16.00</p>
                    </div>
                    <div className="relative group">
                        <Image
